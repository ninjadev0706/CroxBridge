...
export const fetchCroxPoolUserAllowances = async (account: string) => {
...
export const fetchCroxPoolUserTokenBalances = async (account: string) => {
  const calls = farmsConfig.map((farm) => {
    const lpContractAddress = farm.lpAddresses[CHAIN_ID];
    return {
      address: lpContractAddress,
...
export const fetchCroxPoolUserStakedBalances = async (account: string) => {
  const masterChefAdress = getMasterChefAddress();
...
export const fetchCroxPoolUserNextHarvestUntil = async (account: string) => {
  const masterChefAdress = getMasterChefAddress();
...
export const fetchCroxPoolUserEarnings = async (account: string) => {
  const masterChefAdress = getMasterChefAddress();
