...
import { Flex, Text, Skeleton } from "crox-uikit";
      ...
      <FCard>
        ...
        {!removed && (
          <Flex justifyContent="space-between" alignItems="center">
            <Text color="textSubtle">{TranslateString(352, "APR")}:</Text>
            <Text
              color="textSubtle"
              bold
        ...
        <Flex justifyContent="space-between">
          <Text color="textSubtle" style={{ fontSize: "24px" }}>
            {TranslateString(10001, "Deposit Fee")}:
          </Text>
          <Text color="textSubtle" bold style={{ fontSize: "24px" }}>
